...
import com.impinge.soul.adapter.FreeTrialAdapter;
import com.impinge.soul.adapter.SubscriptionAdapter;
...
public class SubscriptionActivity extends BaseActivity implements View.OnClickListener, PurchasesUpdatedListener {
    ...
    public static final String ITEM_SKU = "lt2016.12mo";
    ...
    private void setAdapter() {
        ...
        featureList.add("300+ Meditation,Healing & Relaxing songs");
        featureList.add("Guided Meditations & Afirmations");
        featureList.add("Alarm Clock Function");
        featureList.add("Timer");
        featureList.add("Unlimited Offline Downloads");
        freeTrialAdapter = new FreeTrialAdapter(context,featureList);
