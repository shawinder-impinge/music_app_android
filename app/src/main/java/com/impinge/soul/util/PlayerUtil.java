...
public class PlayerUtil {
    ...
    private com.impinge.soul.models.songsPojo songsPojo;
    ArrayList<songsPojo> list = new ArrayList<>();
    CountDownTimer countDownTimer;


    public com.impinge.soul.models.songsPojo getSongsPojo() {
        return songsPojo;
    }

    public void setSongsPojo(com.impinge.soul.models.songsPojo songsPojo) {
    ...
    public void setSongObject(com.impinge.soul.models.songsPojo songObject) {
...
//            }
    ...
    public void setContextParams(ArrayList<com.impinge.soul.models.songsPojo> list, AudioPlayerViewActivity ativity) {
        mActivity = ativity;
        this.list = list;
