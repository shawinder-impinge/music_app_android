package com.impinge.soul.util.sweetdialog;
...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    private Animation mWarningAnim;
    ...
    public SweetAlertDialog(Context context, int alertType) {
        ...
        mSuccessBowAnim = OptAnimationLoader.loadAnimation(getContext(), R.anim.sucess_bow_rotate);
