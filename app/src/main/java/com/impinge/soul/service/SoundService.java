package com.impinge.soul.service;
...
//                play();
    ...
    private Notification prepareNotification() {
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O &&
            ...
            if (playerUtil != null) {
                name = playerUtil.getSongsPojo().getTitle();
            }
        ...
        Intent notificationIntent = new Intent(this, AudioPlayerViewActivity.class);
        notificationIntent.setAction(MusicConstants.ACTION.MAIN_ACTION);
        notificationIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);

        PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, notificationIntent, PendingIntent.FLAG_UPDATE_CURRENT);

        Intent lPauseIntent = new Intent(this, AudioPlayerViewActivity.class);
        lPauseIntent.setAction(MusicConstants.ACTION.PAUSE_ACTION);
        PendingIntent lPendingPauseIntent = PendingIntent.getActivity(this, 0, lPauseIntent, PendingIntent.FLAG_UPDATE_CURRENT);

        Intent playIntent = new Intent(this, AudioPlayerViewActivity.class);
        playIntent.setAction(MusicConstants.ACTION.PLAY_ACTION);
        PendingIntent lPendingPlayIntent = PendingIntent.getActivity(this, 0, playIntent, PendingIntent.FLAG_UPDATE_CURRENT);

        Intent lStopIntent = new Intent(this, AudioPlayerViewActivity.class);
        lStopIntent.setAction(MusicConstants.ACTION.STOP_ACTION);
        PendingIntent lPendingStopIntent = PendingIntent.getActivity(this, 0, lStopIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        PlayerUtil playerUtil = PlayerUtil.getInstance(this, null);
        RemoteViews lRemoteViews = new RemoteViews(getPackageName(), R.layout.radio_notification);

        if (playerUtil != null) {
            CharSequence name = playerUtil.getSongsPojo().getTitle();
            lRemoteViews.setTextViewText(R.id.song_name, name);
        }
        ...
        switch (sStateService) {
            ...
            case MusicConstants.STATE_SERVICE.PAUSE:
                ...
                lRemoteViews.setImageViewResource(R.id.ui_notification_player_button, R.mipmap.app_icon);
                break;
