...
public class ExploreSongs implements Serializable {
    String id,name,songs_length,is_user_fav,title,audios,cover_images,description,listen_count,status,author_name,author_image;
