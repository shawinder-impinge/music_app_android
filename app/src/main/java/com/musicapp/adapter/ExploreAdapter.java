...
public class ExploreAdapter extends RecyclerView.Adapter<ExploreAdapter.ViewHolder> {
    ...
    public ExploreAdapter(Context context, ArrayList<songsPojo> explore_list) {
        this.songs_list = explore_list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.song_title.setText(songs_list.get(position).getName());
