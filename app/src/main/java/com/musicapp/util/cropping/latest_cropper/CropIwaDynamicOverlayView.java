...
import com.musicapp.util.cropping.latest_cropper.shape.CropIwaShape;
import com.musicapp.util.cropping.latest_cropper.util.CropIwaUtils;

import java.util.Arrays;

import static com.musicapp.util.cropping.latest_cropper.util.CropIwaUtils.boundValue;
import static com.musicapp.util.cropping.latest_cropper.util.CropIwaUtils.dpToPx;
import static com.musicapp.util.cropping.latest_cropper.util.CropIwaUtils.enlargeRectBy;
import static com.musicapp.util.cropping.latest_cropper.util.CropIwaUtils.moveRectBounded;
